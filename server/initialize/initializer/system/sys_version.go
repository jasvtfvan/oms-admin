...
// 初始化顺序
const initOrderSysVersion = initializeService.InitOrderSystem + 1
...
func (i *initSysVersion) DataInserted(ctx context.Context) bool {
	return initializer.DataInserted(ctx, &systemModel.SysVersion{}, "version_name = ?", "oms_server")
}
